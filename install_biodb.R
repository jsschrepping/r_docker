...
devtools::install_version("BSgenome.Hsapiens.UCSC.hg38", version="1.4.1", repos="https://bioconductor.org/packages/3.10/data/annotation",upgrade = "never", force = TRUE)
devtools::install_version("BSgenome.Mmusculus.UCSC.mm10", version="1.4.0", repos="https://bioconductor.org/packages/3.10/data/annotation",upgrade = "never", force = TRUE)