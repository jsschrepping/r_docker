...
# install data bases
devtools::install_version("TxDb.Mmusculus.UCSC.mm10.knownGene", version="3.10.0", repos="https://bioconductor.org/packages/3.12/data/annotation",upgrade = "never", force = TRUE)
...
devtools::install_version("org.Mm.eg.db", version="3.12.0", repos="https://bioconductor.org/packages/3.12/data/annotation",upgrade = "never", force = TRUE)
