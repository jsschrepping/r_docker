...
devtools::install_version("tximport", version="1.14.2", repos=c("https://bioconductor.org/packages/3.10/bioc","http://cran.us.r-praoject.org"),upgrade = "never", force = TRUE)
devtools::install_version("tximeta", version="1.4.5", repos=c("https://bioconductor.org/packages/3.10/bioc","http://cran.us.r-praoject.org"),upgrade = "never", force = TRUE)
...
devtools::install_version("iSEE", version="1.6.1", repos=c("https://bioconductor.org/packages/3.10/bioc","http://cran.us.r-project.org"),upgrade = "never", force = TRUE)
...
devtools::install_version("SingleR", version="1.0.6", repos=c("https://bioconductor.org/packages/3.10/bioc","http://cran.us.r-project.org"), upgrade = "never", force = TRUE)
